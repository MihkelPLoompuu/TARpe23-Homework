...
namespace w14_ex2
{
    internal class Program
    {
        ...
        static void List1()
        {
            ...
            using (StreamReader reader = new StreamReader("C:\\Users\\mihke\\Downloads\\TARpe23ProgNädal14TaskZip\\1999_accidents_Deaths.txt")) 
            {
            ...
            // 1999_accidents
            using (StreamReader reader = new StreamReader("C:\\Users\\mihke\\Downloads\\TARpe23ProgNädal14TaskZip\\1999_accidents.txt"))
            {
                string line;
                int Count = 0;
                int Counts = 0;
            ...
            using (StreamReader reader = new StreamReader("C:\\Users\\mihke\\Downloads\\TARpe23ProgNädal14TaskZip\\2009_accidents_Deaths.txt"))
            {
                Console.WriteLine();
            ...
            // 2009_accidents
            using (StreamReader reader = new StreamReader("C:\\Users\\mihke\\Downloads\\TARpe23ProgNädal14TaskZip\\2009_accidents.txt"))
            {
                string line;
                int Count = 0;
                int Counts = 0;
            ...
            using (StreamReader reader = new StreamReader("C:\\Users\\mihke\\Downloads\\TARpe23ProgNädal14TaskZip\\2019_accidents_Deaths.txt"))
            {
                Console.WriteLine();
            ...
            // 2019_accidents
            using (StreamReader reader = new StreamReader("C:\\Users\\mihke\\Downloads\\TARpe23ProgNädal14TaskZip\\2019_accidents.txt"))
            {
                string line;
                int Counts = 0;
                int Count = 0;
